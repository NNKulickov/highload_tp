...
| [Логическая схема](#4logic) 
| [Физическая схема](#5physic)
| [Технологии](#tech)
...
Основное действие с профилем - это вход/выход. 2 запроса
...
С учетом этого данные получаются следующие нагрузочные данные по типам запросов

| Тип                | Допускаемая константа                                      | Кол-во  | Размер(байт) | Cуммарный объем(МБ) | RPS v*(400*10^6) | Пиковое потребление в течение суток v*(8x400x10^6)/(1024x30x24x60x60)(Гбит/с) |
|--------------------|------------------------------------------------------------|---------|--------------|---------------------|------------------|-------------------------------------------------------------------------------|
| Авторизация        | -                                                          | 2       | 518          | 0,001               | 800000000        | 0,0012                                                                        |
| Региональный поиск | 10 - кол-во размещений на странице                         | 1       | 576 * 10     | 0,0055              | 400000000        | 0,0066                                                                        |
| Детальный поиск    | -                                                          | 15      | 3305         | 0,047               | 6000000000       | 0,0566                                                                        |
| Картинки           | 40кб - средний вес изображения 1024x768, 10 - кол-во фоток | 15      | 40960*10     | 5,8594              | 6000000000       | 7,0643                                                                        |
| Бронирование       | -                                                          | 2       | 24           | 0                   | 800000000        | 0                                                                             |
| Отмена             | -                                                          | 1       | 24           | 0                   | 400000000        | 0                                                                             |
